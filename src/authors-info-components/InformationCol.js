...
class InformationCol extends React.Component {
 render() {
   const sergio = {name: 'Sergio', task: 'Hi, everyone I worked mainly on the game logic and the model creation for the main character.', src: sergiopxl, git: 'https://github.com/sergiopicca', lnk:'https://www.linkedin.com/in/sergio-picca-801b0b173/'}
